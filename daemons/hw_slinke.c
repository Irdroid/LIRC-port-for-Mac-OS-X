...
#   ifdef DEBUG
    logprintf(2,"port #%d: %s\n",q->port_id,to_byte_string(buf,len));
...
#   ifdef DEBUG
    logprintf(3,"accept_rx_byte %02x\n",rch);
#   endif
    switch (state){
